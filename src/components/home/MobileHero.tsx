    ...
    >
      ...
      {/* iPod */}
        <div className="ipod-float mx-auto w-full max-w-[330px]">
            <div
                className="rounded-[34px] border-2 border-[var(--line)] bg-[var(--paper-dark)] p-4 shadow-[7px_9px_0_rgba(60,48,45,0.12)] transition-transform duration-300 ease-out"
                style={{
                transform: isPressed
                    ? "scale(0.985)"
                    : selected === "sound"
            ...
            {/* Podcast */}
                <button
                    type="button"
                    onClick={() => handleScreenSelect("podcast")}
